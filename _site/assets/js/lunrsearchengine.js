...
var documents = [{
    ...
    "id": 8,
    "url": "http://localhost:4000/command/",
    "title": "Git 명령어",
    "body": "2020/05/21 - git init git status git add [파일명] git add –all git rm [파일명] git commit -m [설명] git log git config –global user. email [이메일] git config –global user. name [이름] git remote add [별칭] 깃주소 git remote git push [별칭] master git push [별칭] +master git pull [별칭] master bundle exec jekyll serve "
    }, {
    "id": 9,
